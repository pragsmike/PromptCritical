...
(def price-table
  ...
  {;; --- OpenAI Models ---
   ...
   "anthropic/claude-3.7-sonnet"  {:in-per-1k 0.003, :out-per-1k 0.015} ;; Same as 3‑sonnet; hybrid reasoning released Feb 24 2025 :contentReference[oaicite:4]{index=4}
